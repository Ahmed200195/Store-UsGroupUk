            ...
            <div class="flex flex-wrap justify-between gap-10 mt-5">
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center gap-2 w-full md:my-0 my-2">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center gap-2 w-full md:my-0 my-2">
                            <label for="ddlSize" class="w-1/4">القياس</label>
                    ...
                    <div class="flex md:flex-row flex-col items-center gap-x-5 w-full">
                        ...
                        <div class="flex items-center justify-center gap-2 w-full hidden">
                  ...
                  <div class="flex items-center justify-center gap-2 w-full">
                    ...
                    <input id="txtCnt" runat="server" type="number" class="border-2 rounded w-3/4 p-2 text-right" />
                  </div>
                  <div class="flex items-center justify-center gap-2 w-full md:my-0 my-2">
                    <label class="w-1/4">خلفية المنتج</label>
      ...
                </div>
        ...
        <div class="p-8 rounded-md w-full">
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                ...
                                <asp:SqlDataSource ID="sqlImgProduct" runat="server" ConnectionString='<%$ ConnectionStrings:dbUsGroupKw %>'
                                    ...
                                    InsertCommand="INSERT INTO [ProductPhotos] ([Name], [PId]) VALUES (@Name, @PId);">
                                    <DeleteParameters>
            ...
            <asp:SqlDataSource ID="sqlProduct" runat="server"
                ...
                OnInserted="sqlProduct_Inserted" OnUpdated="sqlProduct_Updated"
                SelectCommand="SELECT * FROM [Product] WHERE ([Id] = @Id)"
                UpdateCommand="UPDATE [Product] SET [NameAr] = @NameAr, [NameEn] = @NameEn, [Price] = @Price, [Discount] = @Discount, [infoAr] = @infoAr, [infoEn] = @infoEn, [Photo] = @Photo, [Cnt] = @Cnt, [DId] = @DId, [BId] = @BId, [CId] = @CId, [SId] = @SId WHERE [Id] = @Id">
                <DeleteParameters>
                    <asp:Parameter Name="Id" Type="Int32"></asp:Parameter>
                </DeleteParameters>
                <InsertParameters>
